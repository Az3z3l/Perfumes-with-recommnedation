...
const Upload_Data =async()=>{
    setloading(true)
    console.log(images);
    const data={"data":images,name,price,description,prodcode,categroy,qty,custtype,status,rating}
...
<div class="w-full max-w-lg" >
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    ...
    <div class="w-full px-3">
      ...
      <input onChange={(e)=>{setQty(e.target.value)}} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="8ml,9ml"/>
